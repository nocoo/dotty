...
import { chartAxis, chartNegative, chartPositive } from "@/lib/palette";
		...
		<div className="space-y-4">
			...
			<div className="h-full flex flex-col rounded-[var(--radius-card)] bg-muted p-4 md:p-5">
				...
				<div className="flex items-center gap-2 mb-1">
					...
					<h1 className="text-lg font-semibold text-foreground font-display">
						Cash flow comparison and net analysis
					</h1>
				</div>
			...
			<div className="grid grid-cols-1 gap-3 md:gap-4 sm:grid-cols-3">
				...
				<div className="h-full flex flex-col rounded-[var(--radius-card)] bg-muted p-4 md:p-5">
					...
					<h2 className="text-xl md:text-2xl font-semibold text-muted-foreground font-display tracking-tight font-mono-num">
