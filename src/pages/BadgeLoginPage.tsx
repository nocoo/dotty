			...
			<div className="flex flex-col items-center">
				...
				>
					...
					<div className="flex flex-1 flex-col items-center px-6 pt-6 pb-14">
						...
						<button
							type="button"
							className="flex w-full items-center justify-center gap-2.5 rounded-[var(--radius-widget)] bg-secondary px-4 py-3 text-sm font-medium text-foreground transition-colors hover:bg-accent"
						>
