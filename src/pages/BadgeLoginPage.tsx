...
export default function BadgeLoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-background p-4 overflow-hidden">
      {/* Radial glow — cool monochrome, eased gradient to prevent banding */}
      <div
        className="pointer-events-none absolute inset-0"
        style={{
          background: [
            "radial-gradient(ellipse 70% 55% at 50% 50%,",
            "hsl(220 10% 50% / 0.045) 0%,",
            "hsl(220 10% 50% / 0.042) 10%,",
            "hsl(220 10% 50% / 0.036) 20%,",
            "hsl(220 10% 50% / 0.028) 32%,",
            "hsl(220 10% 50% / 0.020) 45%,",
            "hsl(220 10% 50% / 0.012) 58%,",
            "hsl(220 10% 50% / 0.006) 72%,",
            "hsl(220 10% 50% / 0.002) 86%,",
            "transparent 100%)",
          ].join(" "),
        }}
      />
      <div className="flex flex-col items-center">
        ...
        <div
          className="relative aspect-[54/86] w-72 overflow-hidden rounded-[var(--radius-card)] bg-card flex flex-col ring-1 ring-border"
          style={{
            boxShadow: [
        ...
        >
          ...
          <div className="flex flex-1 flex-col items-center px-6 pt-6 pb-14">
            ...
            <button className="flex w-full items-center justify-center gap-2.5 rounded-[var(--radius-widget)] bg-secondary px-4 py-3 text-sm font-medium text-foreground transition-colors hover:bg-accent">
