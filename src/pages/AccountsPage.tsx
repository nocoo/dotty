  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        {accountList.map((acc) => (
          <div key={acc.name} className="h-full flex flex-col rounded-[var(--radius-card)] bg-muted p-5">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        {cards.map((card) => (
          <div key={card.name} className="h-full flex flex-col rounded-[var(--radius-card)] bg-muted p-4">
      ...
      <div className="flex flex-col gap-2 md:hidden">
        {records.map((tx) => (
          <div key={tx.id} className="h-full flex flex-col rounded-[var(--radius-card)] bg-muted p-4">
            <div className="flex items-center gap-3">
