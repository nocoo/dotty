    ...
    <div className="space-y-4">
      ...
      <div className="rounded-[var(--radius-card)] bg-secondary p-4 md:p-5">
        ...
        <div className="flex items-center gap-2 mb-1">
          ...
          <h1 className="text-lg font-semibold text-foreground font-display">Composable blocks and visual modules</h1>
        </div>
        <p className="text-sm text-muted-foreground">
          Metric cards, charts, lists, action grids, and target trackers that can be reused across pages.
        </p>
      </div>
      ...
      <Section title="Highlights" icon={Activity}>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="rounded-[var(--radius-widget)] border border-border bg-card p-4">
            ...
            <button className="mt-3 rounded-[var(--radius-widget)] bg-secondary px-3 py-2 text-xs text-foreground">View module</button>
          </div>
          <div className="rounded-[var(--radius-widget)] border border-border bg-card p-4">
            ...
            return (
              <div key={goal.name} className="rounded-[var(--radius-widget)] border border-border bg-card p-5">
                ...
                <div className="mt-3 flex items-center gap-4">
                  <span className="text-xs text-muted-foreground">Monthly target: <span className="font-mono-num">${goal.monthlyTarget.toLocaleString()}</span></span>
