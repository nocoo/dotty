...
function InlineAlert({
	...
	return (
		<div
			className={`flex items-start gap-3 rounded-[var(--radius-widget)] border ${s.border} ${s.bg} p-4`}
		>
		...
		<div className="space-y-4">
			...
			<Section title={t("pages.interactive.inlineAlerts")} icon={AlertTriangle}>
				<div className="space-y-3">
					<InlineAlert
						variant="info"
						title={t("pages.interactive.alertUpdateTitle")}
						message={t("pages.interactive.alertUpdateDesc")}
					/>
					<InlineAlert
						variant="success"
						title={t("pages.interactive.alertPaymentTitle")}
						message={t("pages.interactive.alertPaymentDesc")}
					/>
					<InlineAlert
						variant="warning"
						title={t("pages.interactive.alertStorageTitle")}
						message={t("pages.interactive.alertStorageDesc")}
					/>
					<InlineAlert
						variant="error"
						title={t("pages.interactive.alertConnectionTitle")}
						message={t("pages.interactive.alertConnectionDesc")}
					/>
				</div>
			</Section>
				...
				<div className="space-y-4 max-w-md">
					<div className="space-y-1">
						<div className="flex justify-between text-xs text-muted-foreground">
							...
							<span className="font-mono-num">60%</span>
						</div>
						<Progress value={60} />
					</div>
				...
				<div className="flex flex-wrap gap-3">
					...
					<Popover>
						...
						<PopoverContent className="w-72">
							...
							<div className="space-y-1">
								{[
									t("pages.interactive.profileSettings"),
									t("pages.interactive.billing"),
									t("common.signOut"),
								].map((item) => (
									<button
										type="button"
