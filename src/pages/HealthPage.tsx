...
const statCardKeys = [
	...
	{
		tKey: "calories",
		subtitleKey: "burnedToday",
		value: "2,130",
		icon: Flame,
		trendValue: -1.4,
		trendKey: "vsYesterday",
	},
	{
		tKey: "hydration",
		subtitleKey: "goal3L",
...
const aiStatCardKeys = [
	...
	{
		tKey: "automation",
		subtitleKey: "tasksHandled",
		value: "68%",
		icon: Zap,
		trendValue: 6.8,
		trendKey: "vsLastMonth",
	},
];
...
export default function HealthPage() {
	...
	const timelineEvents = timelineEventKeys.map((e) => ({
		...
		subtitle:
			"subtitleKey" in e && e.subtitleKey
				? t(`pages.health.${e.subtitleKey}`)
				: "subtitle" in e
					? (e as { subtitle: string }).subtitle
					: undefined,
	}));
	...
	return (
		<div className="space-y-4">
			...
			<div className="h-full flex flex-col rounded-[var(--radius-card)] bg-muted p-4 md:p-5">
				...
				<p className="text-sm text-muted-foreground">{t("pages.health.description")}</p>
			</div>
			...
			<div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
				<div className="h-full flex flex-col rounded-[var(--radius-card)] bg-muted p-4 md:p-5">
					<div className="mb-4 flex items-center gap-2">
						...
						<span className="ml-auto text-sm font-semibold text-foreground font-mono-num">
							7h 24m
						</span>
					</div>
			...
			<div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
				<div className="h-full flex flex-col rounded-[var(--radius-card)] bg-muted p-4 md:p-5">
					...
					<button
						type="button"
						className="mt-4 w-full rounded-[var(--radius-widget)] bg-primary px-4 py-2 text-sm font-medium text-primary-foreground"
					>
				...
				<div className="h-full flex flex-col rounded-[var(--radius-card)] bg-muted p-4 md:p-5">
					...
					<div className="space-y-3">
						{recommendations.map((item) => (
							<div
								key={item.title}
								className="rounded-[var(--radius-widget)] border border-border bg-card p-3"
							>
