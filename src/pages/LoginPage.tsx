				...
				<div className="h-full flex flex-col rounded-[var(--radius-card)] bg-muted">
					...
					<div className="flex-1 rounded-[var(--radius-card)] bg-card border border-border p-5">
						<form onSubmit={(e) => e.preventDefault()} className="space-y-4">
							...
							<button
								type="submit"
								className="flex w-full items-center justify-center gap-2 rounded-[var(--radius-widget)] bg-primary px-4 py-2.5 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90"
							>
							...
							<div className="grid grid-cols-2 gap-3">
								<button
									type="button"
									className="flex items-center justify-center gap-2 rounded-[var(--radius-widget)] bg-secondary px-4 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-accent"
								>
									<svg
										className="h-4 w-4"
										viewBox="0 0 24 24"
