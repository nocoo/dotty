...
const useStatCards = (t: (key: string) => string) => [
	{
		...
		icon: Server,
		trend: { value: 0.02, label: "vs last month" },
	},
	{
	...
	},
	{
		...
		icon: AlertTriangle,
		trend: { value: -0.04, label: "vs last week" },
	},
	{
		...
		icon: Router,
		trend: { value: 6.4, label: "vs last week" },
	},
];
	...
	return (
		<div className="space-y-4">
				...
				<div className="mt-2 flex items-center gap-3">
					...
					<div>
						<h1 className="text-lg font-semibold font-display text-foreground">
							{t("pages.networkOps.title")}
						</h1>
						<p className="text-sm text-muted-foreground">{t("pages.networkOps.description")}</p>
					</div>
				</div>
			</div>
			...
			<div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
				...
				<Section
					icon={Clock}
					title={t("pages.networkOps.incidentTimeline")}
