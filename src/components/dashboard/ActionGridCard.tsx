...
const actions = [
  { icon: ArrowUpRight, labelKey: "dashboard.sendMoney" },
  { icon: ArrowDownLeft, labelKey: "dashboard.receive" },
  { icon: CreditCard, labelKey: "dashboard.payBill" },
  { icon: PiggyBank, labelKey: "dashboard.saveAction" },
];
