			...
			<div className="flex-1 rounded-[var(--radius-card)] bg-card border border-border p-5">
				<div className="flex flex-col items-center">
					<div
						...
						role="img"
						aria-label={t("dashboard.creditScoreAria", {
							score,
							max,
							rating: t(`dashboard.${label}`),
						})}
					>
						<div className="relative aspect-square h-[160px]">
							...
							<div className="absolute inset-0 flex flex-col items-center justify-center">
								<span className="text-xl font-semibold text-foreground font-mono-num tracking-tight">
									{score}
								</span>
					...
					<div className="mt-3 grid w-full grid-cols-3 gap-x-4 gap-y-3">
						...
						<div className="flex flex-col items-center gap-0.5">
							<span className={`text-sm font-medium font-display ${color}`}>
								{t(`dashboard.${label}`)}
							</span>
